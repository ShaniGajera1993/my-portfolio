<template>
  <section id="education">
    <div class="bg-slate-100 mt-10 sm:w-1/3 lg:w-full">
      ...
      <div class="flex justify-center items-start mt-10 mx-auto max-w-screen-xl">
        <div
          class="group w-1/3 bg-white border border-gray-200 rounded-lg shadow m-5 hover:bg-gradient-to-b from-blue-950 via-indigo-700 to-indigo-500 p-5"
        >
          ...
          <p>
            <span class="text-gray-700 group-hover:text-slate-300"> GPA: 3.9 </span>
          </p>
        </div>
      ...
      <div class="flex justify-center items-start mt-10 mx-auto max-w-screen-xl">
        <div class="w-1/3"></div>
        <div
          class="group w-1/3 ml-5 bg-white border border-gray-200 rounded-lg shadow p-5 hover:bg-gradient-to-b from-blue-950 via-indigo-700 to-indigo-500"
        >
          <h5 class="mb-2 text-2xl font-bold tracking-tight text-black group-hover:text-white">
            Associate's Degree
          </h5>
